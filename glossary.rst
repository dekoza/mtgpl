...
Słowniczek słów kluczowych, podstawowych pojęć oraz slangu.

Przyjęto następujący układ - pojęcie oryginalne oraz tłumaczenia - krótkie wyjaśnienie wraz z odnośnikami do innych terminów.
Oznacznia reguł odnoszą się do pełnych zasad gry *Magic*, które zostaną udostępnione w tym serwisie niebawem.
...
.. glossary::
   ...
   Dependency
      A system that may be used to determine in which order continuous effects in the same layer or sublayer are applied. See-rule 613.7. See also :term:`Timestamp Order`.
   ...
   Enchantment
      A card type. An enchantment is a permanent. See-rule 303, "Enchantments." See also :term:`Aura`.
   ...
   Flipped
      A status a permanent may have. See-rule 110.6 and rule 709, "Flip Cards." See also :term:`Unflipped`.
   ...
   Hidden Zone
      A zone in which not all players can be expected to see the cards' faces. See-rule 400.2. See also :term:`Public Zone`.
   ...
   Layer
      A system used to determine in which order continuous effects are applied. See-rule 613, "Interaction of Continuous Effects." See also :term:`Dependency`, :term:`Timestamp Order`.
   ...
   Legendary
      A supertype that's normally relevant on permanents. See-rule 205.4, "Supertypes." See also :term:`Legend Rule`.
   ...
   Multikicker
      Multikicker is a variant of the kicker keyword ability. It represents an optional additional cost that may be paid any number of times. See-rule 702.32, "Kicker." See also :term:`Kicker`.
   ...
   One-Shot Effect
      An effect that does something just once and doesn't have a duration. See-rule 610, "One-Shot Effects." See also :term:`Continuous Effect`.
   ...
   Public Zone
      A zone in which all players can be expected to see the cards' faces. See-rule 400.2. See also :term:`Hidden Zone`.
   ...
   Reach
      A keyword ability that allows a creature to block an attacking creature with flying. See-rule 702.17, "Reach." See also :term:`Flying`.
   ...
   Summoning Sickness Rule
      Informal term for a player's inability to attack with a creature or to activate its abilities that include the tap symbol or the untap symbol unless the creature has been under that player's control since the beginning of that player's most recent turn. See-rule 302.6. See also :term:`Haste`.
   ...
   Tapped
      A status a permanent may have. See-rule 110.6 and rule 701.20, "Tap and Untap." See also :term:`Untapped`.
   ...
   Timestamp Order
      A system used to determine in which order continuous effects in the same layer or sublayer are applied. See-rule 613.6. See also :term:`Dependency`.
   ...
   Unflipped
      A default status a permanent may have. See-rule 110.6 and rule 709, "Flip Cards." See also :term:`Flipped`.
   ...
   Untapped
      A default status a permanent may have. See-rule 110.6 and rule 701.20, "Tap and Untap." See also :term:`Tapped`.
   ...
   World
      A supertype that's normally relevant on enchantments. See-rule 205.4, "Supertypes." See also :term:`World Rule`.
