...
Before reading the rules below, please read :doc:`the philosophy of commander<commander_philosophy>`; simply following the rules is not sufficient to ensure a good play experience.
...
#. With the exception of basic lands, no two cards in the deck may have the same English name. Some cards (e.g. :mtgtip:`Relentless Rats`) may have rules text that overrides this restriction.
...
#. Parts of abilities which bring other traditional card(s) you own from outside the game into the game (such as :mtgtip:`Living Wish`; :mtgtip:`Spawnsire of Ulamog`; :mtgtip:`Karn, the Great Creator`; :mtgtip:`Wish`) do not function in Commander.
