...
Alchemist's Refuge
    ...
    |mana_g| |mana_u|, |tap|: You may cast nonland cards this turn as though they had flash.
...
Battle Hymn
    Add |mana_r| to your mana pool for each creature you control.
...
Corpse Traders
    |mana_2| |mana_b|, Sacrifice a creature: Target opponent reveals his or her hand. You choose a card from it. That player discards that card. Activate this ability only any time you could cast a sorcery.
...
Gallows at Willow Hill
    |mana_3|, |tap|, Tap three untapped Humans you control: Destroy target creature. Its controller puts a 1/1 white Spirit creature token with flying onto the battlefield.
...
Scalding Devil
    |mana_2| |mana_r|: Scalding Devil deals 1 damage to target player.
...
Thunderbolt
    Choose one — Thunderbolt deals 3 damage to target player
...
Ulvenwald Tracker
    |mana_1| |mana_g|, |tap|: Target creature you control fights another target creature. (Each deals damage equal to its power to the other.)
